...
const TimeRow = (props: TimeRowProps) => {
    ...
    const handleChange = (value: string) => {
        ...
        PlainSettings.plugins.CustomTimestamps.instantFormats ??= {};
        PlainSettings.plugins.CustomTimestamps.instantFormats[props.id] = value;
...
const settings = definePluginSettings({
    formats: {
        ...
        component: componentProps => {
            ...
            useEffect(() => {
                PlainSettings.plugins.CustomTimestamps.instantFormats = { ...settingsState };
            }, [settingsState]);
